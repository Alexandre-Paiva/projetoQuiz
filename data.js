const questoes = [
  ...
  const msg = [
  {id: 1,mensagem:'OH NÃO! Tente mais uma vez'},
  {id: 2,mensagem:'BOM TRABALHO! Pratique um pouco mais'},
  {id: 3,mensagem:'MUITO BOM! Você acertou a maioria'},
  {id: 4,mensagem:'EXCELENTE! Você é um verdadeiro expert'}
  ];
